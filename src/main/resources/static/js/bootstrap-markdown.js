 ...
 * https://quantmscubism.github.io/bootstrap-markdown.html
 * ===================================================
            ...
            for (i = 0; i < buttonsArray.length; i++) {
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    for (z = 0; z < buttons.length; z++) {
                        ...
                        buttonContainer.text(' ' + this.__localize(btnText)).addClass('btn btn-outline-secondary').addClass(btnClass);
                        if (btnClass.match(/btn\-(primary|success|info|warning|danger|link)/)) {
                            buttonContainer.removeClass('btn btn-outline-secondary');
                        }
        ...
        buttons: [
            [{
                ...
                data: [{
                    ...
                    hotkey: 'Ctrl+I',
                    icon: {
                        bootstrap: 'bi bi-type-italic',
                        glyph: 'bi bi-type-bold',
                        fa: 'fa fa-italic',
                        'fa-3': 'icon-italic',
                        'fa-5': 'fas fa-italic',
                ...
                data: [{
                    ...
                    title: 'Quote',
                    icon: {
                        bootstrap: 'bi bi-blockquote-left',
