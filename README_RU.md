...
1. **Создание и обмен сообщениями**: Основной функционал проекта заключается в возможности создания сообщений с
   ...
   отправленное сообщение, обеспечивая конфиденциальность и удобство общения. Если вы авторизированны - сохраняется
   история ваших писем и появляется возможность редактирования уже созданных.
